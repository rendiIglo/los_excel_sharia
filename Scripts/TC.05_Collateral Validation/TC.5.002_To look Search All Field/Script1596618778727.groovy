...
'lihat data yang ada'
WebUI.setText(findTestObject('TC.05_Collateral Validation/text App Number'), '202007690LS00033')

WebUI.click(findTestObject('TC.05_Collateral Validation/select icon resolve'))

'lihat data yang ada'
WebUI.setText(findTestObject('TC.05_Collateral Validation/text App Date 1'), '01-Jul-2020')

'lihat data yang ada'
WebUI.setText(findTestObject('TC.05_Collateral Validation/text App Date 2'), '10-Jul-2020')

WebUI.click(findTestObject('TC.05_Collateral Validation/klik drop down product'))

WebUI.click(findTestObject('TC.05_Collateral Validation/select product cars'))

'lihat data yang ada'
WebUI.setText(findTestObject('TC.05_Collateral Validation/txtCustomerName'), 'BUDIMAN')

'lihat data yang ada'
WebUI.setText(findTestObject('TC.05_Collateral Validation/text Approval Date 1'), '01-Jul-2020')

'lihat data yang ada'
WebUI.setText(findTestObject('TC.05_Collateral Validation/text Approval Date 2'), '10-Jul-2020')
