...
not_run: WebUI.click(findTestObject('TC.05_Collateral Validation/klik drop down product'))

not_run: WebUI.click(findTestObject('TC.05_Collateral Validation/select product cars'))
...
not_run: WebUI.click(findTestObject('TC.05_Collateral Validation/btnSearch'))
