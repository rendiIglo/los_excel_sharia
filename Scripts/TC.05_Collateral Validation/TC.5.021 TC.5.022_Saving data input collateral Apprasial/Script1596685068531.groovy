...
WebUI.click(findTestObject('TC.05_Collateral Validation/klik option eksterior mobil'))
...
WebUI.click(findTestObject('TC.05_Collateral Validation/klik drop down value eksterior'))

WebUI.click(findTestObject('TC.05_Collateral Validation/select data eksterior mobil'))

WebUI.click(findTestObject('TC.05_Collateral Validation/btnSavePopUp'))

WebUI.click(findTestObject('TC.05_Collateral Validation/select data for upload'))

WebUI.click(findTestObject('TC.05_Collateral Validation/klik tulisan upload'))
...
WebUI.setText(findTestObject('Master/UploadPhoto/txtReceiveBy'), 'CA Syariah')

WebUI.setText(findTestObject('Master/UploadPhoto/txtDocumentNo'), '2')

WebUI.click(findTestObject('TC.05_Collateral Validation/klik gambar upload'))
...
WebUI.click(findTestObject('TC.05_Collateral Validation/btnOkPopUp'))
