...
not_run: WebUI.click(findTestObject('TC.05_Collateral Validation/select data collateral validation'))

not_run: WebUI.click(findTestObject('TC.05_Collateral Validation/btnProcess'))
