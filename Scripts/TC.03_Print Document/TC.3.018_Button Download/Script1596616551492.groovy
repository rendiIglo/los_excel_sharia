...
WebUI.setText(findTestObject('TC.03_Print Document/txtAppsNum'), '202007690LS00379')
...
WebUI.click(findTestObject('TC.03_Print Document/ddl_DocumentTypeItem_BAST'))
