...
WebUI.click(findTestObject('TC.04 Credit Application Inquiry/menu Credit Application Inquiry'))
...
not_run: WebUI.setText(findTestObject('TC.04 Credit Application Inquiry/txtApplicationNumber'), '202007690LS00183')

not_run: WebUI.click(findTestObject('TC.04 Credit Application Inquiry/btnSearch'))
...
not_run: WebUI.click(findTestObject('TC.04 Credit Application Inquiry/select data credit app inquiry'))

not_run: WebUI.click(findTestObject('TC.04 Credit Application Inquiry/btnDetail'))
...
not_run: WebUI.click(findTestObject('TC.04 Credit Application Inquiry/select tab application'))

not_run: WebUI.click(findTestObject('TC.04 Credit Application Inquiry/select tab customer data'))

not_run: WebUI.click(findTestObject('TC.04 Credit Application Inquiry/select tab credit summary'))

not_run: WebUI.click(findTestObject('TC.04 Credit Application Inquiry/select tab document checklist'))

not_run: WebUI.click(findTestObject('TC.04 Credit Application Inquiry/select data document checklist'))

not_run: WebUI.click(findTestObject('TC.04 Credit Application Inquiry/select button view'))
