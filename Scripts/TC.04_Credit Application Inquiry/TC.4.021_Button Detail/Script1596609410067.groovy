...
WebUI.click(findTestObject('TC.04 Credit Application Inquiry/select data credit app inquiry'))

WebUI.click(findTestObject('TC.04 Credit Application Inquiry/btnDetail'))
