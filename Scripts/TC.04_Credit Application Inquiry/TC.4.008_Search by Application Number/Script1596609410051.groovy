...
WebUI.setText(findTestObject('TC.04 Credit Application Inquiry/txtApplicationNumber'), '202007690LS00183')

WebUI.click(findTestObject('TC.04 Credit Application Inquiry/btnSearch'))
