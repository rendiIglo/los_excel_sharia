...
WebUI.click(findTestObject('TC.04 Credit Application Inquiry/select tab document checklist'))

WebUI.click(findTestObject('TC.04 Credit Application Inquiry/select data document checklist'))
