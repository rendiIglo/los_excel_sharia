...
'lihat data yang ada'
not_run: WebUI.setText(findTestObject('TC.05_Funding_Preparation/Screen Funding Preparation/text App Number'), '202007690LS00183')

not_run: WebUI.click(findTestObject('TC.05_Funding_Preparation/Screen Funding Preparation/select icon resolve'))

not_run: WebUI.click(findTestObject('TC.05_Funding_Preparation/Screen Funding Preparation/btnSearch'))
