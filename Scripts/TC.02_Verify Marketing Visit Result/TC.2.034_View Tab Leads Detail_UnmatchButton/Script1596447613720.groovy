...
WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Spouse/ddlSpouseProfessionItem_WIRASWASTA'))
...
WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/jobs/ddl_ProfessionItem_WIRASWASTA'))
...
WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income konsumen Wiraswasta/span_UnmatchOmzet'))

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income konsumen Wiraswasta/span_UnmatchBiayaProduksi'))

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income konsumen Wiraswasta/span_UnmatchBiayaOperasional'))

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income konsumen Wiraswasta/span_UnmatchNetIncome'))

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income konsumen Wiraswasta/span_UnmatchPenjualan3Bulan'))

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income konsumen Wiraswasta/span_UnmatchPembelian3Bulan'))

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income konsumen Wiraswasta/span_UnmatchNotaNetIncome'))

WebUI.setText(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income konsumen Wiraswasta/txtOmzet'), '12000001')

WebUI.setText(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income konsumen Wiraswasta/txtBiayaProduksi'), 
    '12000002')

WebUI.setText(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income konsumen Wiraswasta/txtBiayaOperasional'), 
    '12000003')

WebUI.setText(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income konsumen Wiraswasta/txtNetIncome'), 
    '12000004')

WebUI.setText(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income konsumen Wiraswasta/txtPenjualan3Bulan'), 
    '12000005')

WebUI.setText(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income konsumen Wiraswasta/txtPembelian3Bulan'), 
    '12000006')

WebUI.setText(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income konsumen Wiraswasta/txtNotaNetIncome'), 
    '12000007')

WebUI.comment('pasangan')

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income Pasangan Wiraswasta/span_UnmatchSpouseOmzetPerBulan'))

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income Pasangan Wiraswasta/span_UnmatchSpouseBiayaProduksi'))

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income Pasangan Wiraswasta/span_UnmatchSpouseBiayaOperasional'))

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income Pasangan Wiraswasta/span_UnmatchSpouseNetIncome'))

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income Pasangan Wiraswasta/span_UnmatchSpousePenjualan3Bulan'))

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income Pasangan Wiraswasta/span_UnmatchSpousePembelian3Bulan'))

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income Pasangan Wiraswasta/span_UnmatchSpouseNotaNetIncome'))

WebUI.setText(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income Pasangan Wiraswasta/txtOmzet'), '11000001')

WebUI.setText(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income Pasangan Wiraswasta/txtBiayaProduksi'), 
    '11000002')

WebUI.setText(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income Pasangan Wiraswasta/txtBiayaOperasional'), 
    '11000003')

WebUI.setText(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income Pasangan Wiraswasta/txtNetIncome'), 
    '11000004')

WebUI.setText(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income Pasangan Wiraswasta/txtPenjualan3Bulan'), 
    '11000006')

WebUI.setText(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income Pasangan Wiraswasta/txtPembelian3Bulan'), 
    '11000007')

WebUI.setText(findTestObject('TC.02_Verify Marketing Visit Result/Additional/Income Pasangan Wiraswasta/txtNotaNetIncome'), 
    '11000008')

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Additional/a_NextButton'))

WebUI.comment('Leads Detail')

WebUI.delay(1)

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Leads Detail/span_FirstData'))

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Leads Detail/a_Unmatch'))

WebUI.waitForElementPresent(findTestObject('Master/divLoadingPopUp'), 0)

WebUI.waitForElementNotPresent(findTestObject('Master/divLoadingPopUp'), 0)

WebUI.setText(findTestObject('TC.02_Verify Marketing Visit Result/Leads Detail/txtLicensePlate'), 'D 566 SD')

WebUI.click(findTestObject('TC.02_Verify Marketing Visit Result/Leads Detail/a_SaveButton'))
