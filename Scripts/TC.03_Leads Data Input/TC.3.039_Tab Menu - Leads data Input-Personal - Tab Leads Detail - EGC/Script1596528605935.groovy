...
not_run: WebUI.click(findTestObject('TC.03_Leads Data Input/Leads Detail/ddl_referralName'))
...
not_run: WebUI.setText(findTestObject('TC.03_Leads Data Input/Leads Detail/txtBranchId'), '690')

not_run: WebUI.click(findTestObject('TC.03_Leads Data Input/Leads Detail/a_SearchButton'))

not_run: WebUI.waitForElementPresent(findTestObject('Master/divLoading'), 10)

not_run: WebUI.waitForElementNotPresent(findTestObject('Master/divLoading'), 10)

not_run: WebUI.click(findTestObject('TC.03_Leads Data Input/Leads Detail/ddl_chooseReferralName'))

not_run: WebUI.click(findTestObject('TC.03_Leads Data Input/Leads Detail/a_ChooseButton'))
