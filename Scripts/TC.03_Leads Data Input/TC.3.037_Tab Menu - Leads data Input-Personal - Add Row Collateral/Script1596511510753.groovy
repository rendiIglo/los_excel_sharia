...
WebUI.click(findTestObject('TC.03_Leads Data Input/Leads Detail/span_ddlActivity_WalkInBFI'))
...
not_run: WebUI.click(findTestObject('TC.03_Leads Data Input/Leads Detail/a_CalculateButton'))
