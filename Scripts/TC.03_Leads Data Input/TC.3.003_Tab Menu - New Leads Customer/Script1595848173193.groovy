...
not_run: WebUI.setText(findTestObject('TC.03_Leads Data Input/Customer/txtNameSpouse'), 'Kang Ujang')

not_run: WebUI.setText(findTestObject('TC.03_Leads Data Input/Customer/txtIdNoSpouse'), '2345671206890001')

not_run: WebUI.setText(findTestObject('TC.03_Leads Data Input/Customer/txtMobilePhoneSpouse'), '0857363636')

not_run: WebUI.setText(findTestObject('TC.03_Leads Data Input/Customer/txtDateOfBirthSpouse'), '12-Jun-1989')

not_run: WebUI.setText(findTestObject('TC.03_Leads Data Input/Customer/txtPlaceOfBirthSpouse'), 'Jakarta')
