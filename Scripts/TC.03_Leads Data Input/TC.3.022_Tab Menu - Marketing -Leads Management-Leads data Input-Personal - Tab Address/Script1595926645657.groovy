...
not_run: WebUI.click(findTestObject('TC.03_Leads Data Input/Address/ddl_SameAddress'))

not_run: WebUI.click(findTestObject('TC.03_Leads Data Input/Address/a_SaveButton'))
...
not_run: WebUI.click(findTestObject('TC.03_Leads Data Input/Address/a_OkButton'))
