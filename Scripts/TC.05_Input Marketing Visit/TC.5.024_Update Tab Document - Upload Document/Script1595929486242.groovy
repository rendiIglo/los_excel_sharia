...
WebUI.setText(findTestObject('TC.05_Input Marketing Visit/Document/txtReceivedBy'), 'marketing syariah')

WebUI.setText(findTestObject('TC.05_Input Marketing Visit/Document/txtExpiredDate'), '28-Jun-2021')

WebUI.setText(findTestObject('TC.05_Input Marketing Visit/Document/txtDocumentNumber'), '1')
