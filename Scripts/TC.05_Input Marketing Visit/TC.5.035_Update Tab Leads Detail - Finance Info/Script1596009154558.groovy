...
WebUI.setText(findTestObject('TC.05_Input Marketing Visit/txtLeadsID'), '20200729690L001300')
...
WebUI.setText(findTestObject('TC.05_Input Marketing Visit/LeadsDetail/FinanceInfo/txtPurchasePrice'), '70285000')

WebUI.setText(findTestObject('TC.05_Input Marketing Visit/LeadsDetail/FinanceInfo/txtDPAmount'), '37480000')

WebUI.setText(findTestObject('TC.05_Input Marketing Visit/LeadsDetail/FinanceInfo/txtTenor'), '24')
...
not_run: WebUI.click(findTestObject('TC.05_Input Marketing Visit/LeadsDetail/a_SubmitButton'))
