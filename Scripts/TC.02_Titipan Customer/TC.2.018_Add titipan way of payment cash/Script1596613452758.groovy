...
WebUI.click(findTestObject('TC.02_Titipan Customer/addTitipan/ddlWayOfPaymentItem_Cash'))

WebUI.setText(findTestObject('TC.02_Titipan Customer/addTitipan/txtAmountReceived'), '1000000')

WebUI.setText(findTestObject('TC.02_Titipan Customer/addTitipan/txtReceivedFrom'), 'Ai Cucum')

WebUI.setText(findTestObject('TC.02_Titipan Customer/addTitipan/txtDescription'), 'Cicilan DP ke 1')
